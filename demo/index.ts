...
const admin = new AdminForth({
  ...
  styles:{
    colors: {
      "html-bg": "#f1f5f9",
      "header-bg": "#FFFFFF",
      "header-bg-hover": "#2d3748",
      "header-text": "#f7fafc",
      "header-text-hover": "#f7fafc",
      "header-icons": "#f7fafc",
      "header-icons-hover": "#f7fafc",
      "header-logo-color": "#f7fafc",
      "header-border-color": "#1a202c",

      "nav-menu-bg": "#1a202c",
      "nav-menu-bg-hover": "#2d3748",
      "nav-menu-bg-active": "#4a5568",
      "nav-menu-hover": "#2d3748",
      "nav-menu-active": "#4a5568",
      "nav-menu-active-text": "#f7fafc",
      "nav-menu-text": "#f7fafc",
      "nav-menu-text-hover": "#f7fafc",
      "nav-menu-text-active": "#f7fafc",
      "nav-menu-devider": "#2d3748",
      "nav-menu-icons": "#f7fafc",
      "nav-menu-heading": "#f7fafc",

      'list-view-bg': '#FAFBFC',
      'list-view-table-bg': '#FAFBFC',
      'list-view-table-heading': '#f1f5f9',
      'list-view-table-heading-text': '#f7fafc',
      'list-view-table-text': '#2d3748',
      'list-view-table-row-hover': '#ffffff',
      'list-view-bread-crumbs-text': '#4a5568',
      'list-view-border-color': '#EDEDED',

      'form-view-bg': '#FAFBFC',
      'form-view-border-color': '#f1f5f9',
  ...
  auth: {
    ...
    loginBackgroundImage: '@@/p.png', // TODO, not working
  },
  customization: {
