            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 dark:shadow-black" >
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" @submit.prevent>
                        ...
                        <button 
                          @click="login"
                          type="submit" class="flex items-center justify-center gap-1 w-full text-white bg-lightPrimary dark:bg-darkPrimary hover:brightness-110 
                             focus:ring-4 
                            focus:outline-none focus:ring-lightPrimary focus:ring-opacity-50 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-darkPrimary dark:focus:ring-opacity-50"
                        >
                          <svg v-if="inProgress"
